...
class model_parser(object):
    ...
    def __init__(self, model_type):
        ...
        if model_type=='STCNNT_UNET' or model_type=='STCNNT_VARNET': 
            self.add_unet_STCNNT_args()
            if(model_type=='STCNNT_VARNET'):
                self.add_varnet_STCNNT_args()
    ...
    def add_varnet_STCNNT_args(self):  
        self.parser.add_argument('--backbone_vnet.kspaceFilling', type=bool, default=False, help="number of unrolls")
        self.parser.add_argument('--backbone_vnet.usesmaps', type=bool, default=False, help="use senstivity maps")
        self.parser.add_argument('--backbone_vnet.num_cascades', type=int, default=3, help="number of unrolls")
        #self.parser.add_argument('--backbone_unet.C', type=int, default=2, help="number of channels in main body of unet")
        self.parser.add_argument('--backbone_vnet.modelType', type=str, default="STCNNT_HRNET", choices=['Identity',
                                                                                                 'STCNNT_HRNET',
                                                                                                 'STCNNT_UNET',
                                                                                                 ], 
                                                                                                help="Which model to use for unrolled reg")
